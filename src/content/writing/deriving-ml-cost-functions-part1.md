...
description: "Mean Squared Error (MSE) - a commonly used cost function for regression problems derived using Maximum Likelihood Estimation (MLE)"
date: 2019-03-24
section: math
...
The purpose of this two-part article is to shed some light on the choice of these cost functions by deriving them using Maximum Likelihood Estimation (MLE). Part I will focus on deriving MSE while [Part II](/deriving-ml-cost-functions-part2) will focus on deriving Cross Entropy.
...
### Footnotes
[^iid]: A set of random variables $X_1, X_2, \cdots, X_n$ are said to be independent and identically distributed if they have the same probability distribution and are mutually independent. [Wikipedia Article](https://en.wikipedia.org/wiki/Independent_and_identically_distributed_random_variables)

[^jpdf]: This [note](https://ocw.mit.edu/courses/mathematics/18-05-introduction-to-probability-and-statistics-spring-2014/readings/MIT18_05S14_Reading7a.pdf) from the [Introduction to Probability and Statistics](https://ocw.mit.edu/courses/mathematics/18-05-introduction-to-probability-and-statistics-spring-2014/) class on MIT OpenCourseWare explains joint probability mass and density functions clearly.
